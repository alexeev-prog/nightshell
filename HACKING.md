...
hidden if the `nightshell_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `nightshell_DEVELOPER_MODE` to the configure
...
Runs the executable target `nightshell_exe`.
